      ...
      <div class="col-sm">
        <form>
          <fieldset>
            ...
            <label class="hide" for="rowHeight"> Row Height(px) </label>
            <input
              id="rowHeight"
              v-model="rowHeight"
              class="hide"
              type="number"
            />
            <label class="hide" for="colNum"> Max Columns </label>
            <input id="colNum" v-model="colNum" class="hide" type="number" />
            <label class="hide" for="maxRows"> Max Rows </label>
            <input id="maxRows" v-model="maxRows" class="hide" type="number" />
            ...
            />
            <br class="hide" />
            <label class="hide" for="autosize"> autosize </label>
            <input
              id="autosize"
            ...
            <label class="hide" for="horizontalShift"> horizontalShift </label>
            <input
              id="horizontalShift"
              ...
              type="checkbox"
            />
            <label class="" for="isBounded"> isBounded </label>
            ...
            <label class="hide" for="isMirrored"> isMirrored </label>
            <input
              id="isMirrored"
              v-model="isMirrored"
              class="hide"
              type="checkbox"
            />
            <label for="isResizable" class="hide"> isResizable </label>
            <input
              id="isResizable"
              v-model="isResizable"
              class="hide"
              type="checkbox"
            />
            <label class="hide" for="isResponsive"> isResponsive </label>
            <input
              id="isResponsive"
              ...
              type="checkbox"
            />
            <label class="hide" for="preserveAspectRatio">
              preserveAspectRatio
            </label>
            <input
              ...
              type="checkbox"
            />
            <label class="hide" for="preventCollision">
              preventCollision
            </label>
            <input
              id="preventCollision"
              ...
              type="checkbox"
            />
            <label class="hide" for="restoreOnDrag"> restoreOnDrag </label>
            <input
              id="restoreOnDrag"
              ...
              type="checkbox"
            />
            <label class="hide" for="showCloseButton"> showCloseButton </label>
            <input
              id="showCloseButton"
              ...
              type="checkbox"
            />
            <label class="hide" for="showGridLines"> showGridLines </label>
            <input
              id="showGridLines"
              ...
              type="checkbox"
            />
            <label class="hide" for="useBorderRadius"> useBorderRadius </label>
            <input
              id="useBorderRadius"
              ...
              type="checkbox"
            />
            <label class="hide" for="verticalCompact"> verticalCompact </label>
            <input
              id="verticalCompact"
    ...
    <div class="row">
      <div class="col-sm hide">
        <div class="layoutJSON">
          ...
          <div class="columns">
            <div v-for="item in testLayout" :key="item.i">
              <b>{{ item.i }}</b
      ...
      <div class="col-sm hide">
        <h4 style="margin-top: 10px">Event log:</h4>
        <div ref="eventsDiv" class="eventsJSON">
          <div v-for="event in eventsLog" :key="event">
            {{ event }}
          </div>
        </div>
      </div>
...
const drag = (e: DragEvent): void => {
  ...
  if (
    mouseInGrid === true &&
    testLayout.value.findIndex((item) => item.i === `drop`) === -1
  ) {
